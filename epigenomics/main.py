...
# Epigenomics-specific lambda reduction list and timing constants
lam_red_list = ['fastqsplit', 'mapmerge', 'chr21', 'pileup']
lam_red_exe  = [141.59390211105347, 109.125657081604, 135.81721138954163, 122.01116299629211]
lam_red_read = [0.08292984962463379, 0.08746027946472168, 0.1231539249420166, 0.08258867263793945]
lam_red_write= [0.031248092651367188, 0.0380702018737793, 0.03576540946960449, 0.04756331443786621]
...
if __name__ == "__main__":
    # ---- Epigenomics workflow configuration ----
    app_name = "epigenomics"
    phase = 9
    app = [
        ['fastqsplit'],
        ['filtercontams'],
    ...
    num_of_app  = [[2], [500], [500], [500], [500], [2], [1], [1], [1]]
    num_in_ec2  = [[2], [0],   [0],   [0],   [0],   [2], [1], [1], [1]]

    instance_ID   = 'i-0af2d8cda0bbcff88'
